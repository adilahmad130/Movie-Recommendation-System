...
file_id = '1cnMcojZCSxljq-4lUE7IVDd_Keqskcrq'
gdrive_url = f"https://drive.google.com/uc?id={file_id}"

# Download the similarity.pkl file using gdown
        ...
        for i in range(len(recommended_names)):
            ...
            with st.container():
                ...
                with col2:
                    ...
                    if reviews:
                        st.markdown(f"<div style='padding: 5px;'><strong>User Reviews:</strong></div>", unsafe_allow_html=True)
                        ...
                        st.write("<div style='padding: 10px; color: #FFFFFF;'>No user reviews available.</div>", unsafe_allow_html=True)
